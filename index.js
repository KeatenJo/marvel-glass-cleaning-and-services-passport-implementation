...
app.options('/appointments/:appointmentId', cors({credentials: true, origin: 'https://marvel-glass-cleaning-passport.herokuapp.com/public/'})) // enable pre-flight request for DELETE request
